...
// Normalizing mouse to range suitable for camera offset (e.g., -20 to 20)
export function onDocumentMouseMove(event) {
  mouse.x = ((event.clientX / window.innerWidth) * 2 - 1) * 20;
  mouse.y = (-(event.clientY / window.innerHeight) * 2 + 1) * 20;
}
