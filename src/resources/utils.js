...
import { mouse } from './eventHandlers';
...
export function rotateCamera(ballPosition) {
  ...
  if (
    ...
    (ballPosition.position.x < -25 &&
      ...
      ballPosition.position.z < 40) ||
    // Bio/Description Area - High Angle View
  ...
  // Apply mouse movement influence to camera position
  targetPos.x += (mouse.x - targetPos.x) * 0.03;
  targetPos.y += (-mouse.y - targetPos.y) * 0.03;
